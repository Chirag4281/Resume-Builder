...
public class EducationUI extends JFrame implements ActionListener
{
	...
	public JLabel l,l1,l2,l3,l4,l5,l6,l7,l8,l9,l10;
    ...
    // Create an instance of EducationUI
    SwingUtilities.invokeLater(() -> {
        new EducationUI("John Doe", "01/01/1990", "John's Father", "American", "1234567890", "john.doe@example.com", "imagePath");
    });
}
